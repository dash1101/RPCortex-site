  ...
  var SCENES = [
    ...
    [
      { cmd: 'wifi connect Example', outputs: [
        ...
        { t: "Connecting to 'Example'... / (3s)", w: 1600 },
        { t: "[@] Connected to 'Example'!  IP: 192.168.1.42  Gateway: 192.168.1.1", w: 950 },
      ]}
    ],
    ...
    [
      ...
      { cmd: 'pkg install HelloWorld', pre: 700, outputs: [
        ...
        { t: '[:] HTTP 200', w: 200 },
        { t: "[@] Extracting to '/Packages/HelloWorld'...", w: 340 },
        { t: "[@] Package 'HelloWorld' v1.0.2 installed.", w: 180 },
      ]}
    ],
    ...
    [
      { cmd: 'fetch', outputs: [
        ...
        { t: '###    ### ###         ########                CPU : RP2350  Dual-Core ARM Cortex-M33', w: 40 },
        { t: '                                              Freq : 150 MHz', w: 40 },
        { t: '                                           Runtime : MicroPython 1.27.0', w: 40 },
        { t: '                                               RAM : 284 KB used / 520 KB total  (54%)', w: 40 },
        { t: '                                             Flash : 1840 KB used / 14336 KB total', w: 40 },
