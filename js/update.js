 ...
 *   /Vela/           — registry, package cache, logs kept intact
 *                      (/Pulsar/ and /Nebula/ too, for devices not yet migrated)
 *
...
(function () {
   ...
   *
   * Skips:  website/, repo/, dev artifacts, AND all of /Vela/, /Pulsar/,
   *         /Nebula/ and /Users/ to preserve user data and settings.
   */
  function shouldUpdate(relPath) {
    var skip = [
      'website/', 'repo/', '.git/', '.git',
      '__pycache__/', 'CLAUDE', 'temp/', 'tests/',
      'Users/', 'Vela/', 'Pulsar/', 'Nebula/'
    ];
